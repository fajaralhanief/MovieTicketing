<?php
  ...
  session_start();
  $_SESSION['film'] = "The Secret - Suster Ngesot Urban Legend";
  $_SESSION['hari'] = "jumat";
  $_SESSION['tanggal'] = "18";
  echo $_SESSION['jam'];
  unset($_SESSION['jam']);
...
<div class="container">
  <div class="jumbotron">
    ...
    <font size="8" face="Century Gothic" style="margin-left: 41px;"><b>THE SECRET - Suster Ngesot Urban Legend</b></font><br>
    <hr width="95.2%" style="margin-left: 41px; border-color: black;">
    <img src = "playing/file3.jpg" width="304" height="450" alt="gambar1" style="margin-top:-440px;margin-left: 40px;">
    <iframe width="665" height="450" src="https://www.youtube.com/embed/bMIKlQRbuzg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    <hr width="95.2%" style="margin-left: 41px; border-color: black;">
    ...
    <a href="file3_14.php"><button class="a">14<font size="4" face="Century Gothic">senin</font></button></a>

    <a href="file3_15.php"><button class="a">15<font size="4" face="Century Gothic">selasa</font></button></a>
    
    <a href="file3_16.php"><button class="a">16<font size="4" face="Century Gothic">rabu</font></button></a>
    
    <a href="file3_17.php"><button class="a">17<font size="4" face="Century Gothic">kamis</font></button></a>
    
    <a href="file3_18.php"><button class="b">18<font size="4" face="Century Gothic">jumat</font></button></a>
    <hr width="95.2%" style="margin-left: 41px; border-color: black;">
    ...
    <font size="5" face="Century Gothic"><br>
      <b>Tempat:</b> <font id="hasil2"> </font> |<b> Tanggal: </b>Jumat, 18 Mei 2018 |
      <b>Film:</b>  THE SECRET - SUSTER NGESOT URBAN LEGEND | <b>Class:</b> 2D | <b>Jam:</b> <font id="hasil"> </font>|
    </font>
    </div>
    <br><br>
...
<input class="c" type="submit" id="submit" name="submit" value="PILIH KURSI" style="float: right;">
</form>
