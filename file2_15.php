...
<div class="container">
  <div class="jumbotron">
    ...
    <font size="8" face="Century Gothic" style="margin-left: 41px;"><b>PLEASE STAND BY</b></font><br>
    <hr width="95.2%" style="margin-left: 41px; border-color: black;">
    <img src = "playing/file2.jpg" width="304" height="450" alt="gambar1" style="margin-top:-440px;margin-left: 40px;">
    <iframe width="665" height="450" src="https://www.youtube.com/embed/ghI4y6otpjY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    <hr width="95.2%" style="margin-left: 41px; border-color: black;">
    ...
    <a href="file2_14.php"><button class="a">14<font size="4" face="Century Gothic">senin</font></button></a>

    <a href="file2_15.php"><button class="b">15<font size="4" face="Century Gothic">selasa</font></button></a>
    
    <a href="file2_16.php"><button class="a">16<font size="4" face="Century Gothic">rabu</font></button></a>
    
    <a href="file2_17.php"><button class="a">17<font size="4" face="Century Gothic">kamis</font></button></a>
    
    <a href="file2_18.php"><button class="a">18<font size="4" face="Century Gothic">jumat</font></button></a>
    <hr width="95.2%" style="margin-left: 41px; border-color: black;">
    ...
    <font size="5" face="Century Gothic"><br>
      ...
      <b>Film:</b>  PLEASE STAND BY | <b>Class:</b> 2D | <b>Jam:</b> <font id="hasil"> </font>|
    </font>
    </div>
    <br><br>
